...
//      private static List<BankAccount> accountList = new List<BankAccount>(); //Solucion: asi se inicializa solo una vez la lista,

      private static TransactionAccount transactionAccount;

      private static UtilityAccountValidation utilityAccountValidation;

      // Por que no hay Clase Program??
      ...
      private static void InsertAccount() //Por que esta clase no esta en transaccional?
      {
         ...
         accountList = new List<BankAccount>(); //EROR: Recreea la Lista cada vez que se Inserta una Cuenta
