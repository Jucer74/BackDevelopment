...
namespace BankApp
{
   ...
   {
      // Las vbles son camelCase
      private static Bank BankUsb = new Bank();
      // De donde viene esta valor magico? por que 1000?
      ...
      public static void Menu()
      {
         ...
         do
         {
            ...
            Console.WriteLine("0. Crear cuenta"); // Crear cuenta ?? deberia decir Salir
      ...
      {
         // que cuenta? No es claro que esta contando
         cont = cont + 1;
         // que es Op? operaacion? 
         // las vbles son camelCase
         bool Op = true;
         int accountNumber;
         string placeHolder;
         ...
         // La funcion hace mas de una Cosa
         // Se Rompe SOLID
      ...
      public static void GetBalanceAccount()
      {
         ...
         do
         {
            ...
            {
               // Bien se controla la Excepcion aca y en las otras?
               Console.WriteLine($"{e.Message}");
               Console.WriteLine("Digite cualquier tecla para repetir.");
            }
            catch (FormatException) // Cuando se va a manipular el Error se necesita el ex.Message
            {
      ...
      {
         int accountNumber;
         double amount = 0.0; // Codigo Innecesario: Donde se usa ?
         bool Op = true;
      ...
      public static void Withdrawal()
      {
         ...
         double amount = 0.0;
         bool Op = true;
         // Vbles Innecesarias donde se usan ??
         string accountType = "";
         ...
         do
         {
            ...
            {
               // Codigos repetidos Todas usan el mismo mensaje y el mismo readkey
               Console.WriteLine($"{e.Message}");
               Console.WriteLine("Digite cualquier tecla para repetir.");
               Console.ReadKey();
            }
