...
## Print Multiples (0.0)
- No tiene Errores Ni Warnings (0.5)      = 0.5
- No tiene Codigo Innecesario  (0.5)      = 0.0 => Adiciona contadores que no son necesarios en lalogica
- Funciona y Cumple con el Objetivo (1.5) = 1.0 => No muestra el resultado esperado en el formato esperado
- El codigo Es Entendible (1.0)           = 1.0 => Si pero la logica esta en una sola funcion
